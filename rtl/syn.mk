...
TOP_MODULE := cve2_top
CORE := "openhwgroup:cve2:cve2_top_vivado:0.1"
TARGET_DIRNAME := openhwgroup_cve2_cve2_top_vivado_0.1
TARGET := synth
BUILD_DIR := ./build/$(TARGET_DIRNAME)/$(TARGET)-vivado
...
#########################################################
# STEP 2: Generate Vivado Project file
#########################################################
.PHONY: vivado_xpr
vivado_xpr: fuse

	@echo "Creating Vivado Project and Synthesis"	
	cd $(BUILD_DIR) && \
	make synth 
