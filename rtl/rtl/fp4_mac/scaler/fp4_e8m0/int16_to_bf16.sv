...
(
    ...
    // NOTE: We subtract 2 because the INT16 representation 
    // is actually Q14.2 (quanta steps of 0.25), so the actual value
    // is 1/4 of what it is!. 
    assign initial_exp = 8'd127 + (8'd15 - 8'd2) - {4'b0, lzc};
