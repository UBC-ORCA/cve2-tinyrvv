...
// -----------------------------
// Fixed planar benchmark layout (must match linker script)
// Toggle ONE block below by commenting/uncommenting.
// Also make sure your linked program was built with the matching linker script.
// -----------------------------

// // === ACTIVE CONFIG: 100 pixels ===
// static constexpr uint32_t PLANAR_NPIX = 100u;
// static constexpr uint32_t IN_R_ADDR   = 0x00010000u;
// static constexpr uint32_t IN_G_ADDR   = 0x00011000u;
// static constexpr uint32_t IN_B_ADDR   = 0x00012000u;
// static constexpr uint32_t OUT_Y_ADDR  = 0x00013000u;

// === 1000 pixels ===
// static constexpr uint32_t PLANAR_NPIX = 1000u;
// static constexpr uint32_t IN_R_ADDR   = 0x00010000u;
// static constexpr uint32_t IN_G_ADDR   = 0x00012000u;
// static constexpr uint32_t IN_B_ADDR   = 0x00014000u;
// static constexpr uint32_t OUT_Y_ADDR  = 0x00016000u;

// === 10000 pixels ===
// static constexpr uint32_t PLANAR_NPIX = 10000u;
// static constexpr uint32_t IN_R_ADDR   = 0x00010000u;
// static constexpr uint32_t IN_G_ADDR   = 0x00020000u;
// static constexpr uint32_t IN_B_ADDR   = 0x00030000u;
// static constexpr uint32_t OUT_Y_ADDR  = 0x00040000u;
